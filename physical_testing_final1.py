...
class OpenVLAClient:
    def __init__(self, server_url: str = "http://10.136.109.82:8000", 
                 ...
                 use_absolute: bool = False, use_threaded_camera: bool = True):
        """
        ...
        if use_absolute:
            ...
            action_scale = 50.0 # Small scale for relative movements
        ...
        self.safety = SafetyMonitor({'x': [150.0, 650.0], 'y': [-500.0, 500.0], 'z': [-1.4, 400.0]})
